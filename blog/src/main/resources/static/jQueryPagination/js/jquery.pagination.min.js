!function (t, a, e, i) {
	...
	n.prototype = {
		...
		render: function () {
			...
			this.checkPage(),
			this.isRender && this.ele.html("<div class='ui-pagination-container'>" + this.homePage + this.prevPage + i + this.nextPage + this.endPage + "</div>")
		},
		checkPage: function () {
			var t = this.opts,
			a = t.totalPage,
		...
		eventBind: function () {
			...
			this.ele.off("click", ".ui-pagination-page-item");
